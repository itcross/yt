  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
       			<h4>  HOME <i class="fa fa-angle-right"></i> 게시판 <i class="fa fa-angle-right"></i> 공지사항</h4>
	                  	...
	                  	<div class="content-panel">
	                          <table class="table table-hover">
	                              ...
	                              <tr>
	                                  ...
	                                  <td>공지사항</td>
	                                  <td><a href="viewnot">do you want to study?</a></td>
	                                  <td>최고관리자</td>
	                                  <td>2017/06/07</td>
	                                  <td>12</td>
				...
				<div class="row mt">
					<div class="col-sm-12 text-right">
						...
						<button type="button" class="btn btn-primary" onclick="location.href='writen'">글쓰기</button>
					</div>
				</div>
          </section>
      </section>
